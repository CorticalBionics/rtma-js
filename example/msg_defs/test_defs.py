...
COMPILED_PYRTMA_VERSION: str = "2.2.1"
...
class MDF_PING(MessageData, metaclass=MessageMeta):
    ...
    type_hash: ClassVar[int] = 0xE6F432EA
    type_size: ClassVar[int] = 4
...
@pyrtma.message_def
class MDF_RASTER(MessageData, metaclass=MessageMeta):
    type_id: ClassVar[int] = 1001
    type_name: ClassVar[str] = "RASTER"
    type_hash: ClassVar[int] = 0xDA51540C
    type_size: ClassVar[int] = 516
    type_source: ClassVar[str] = "test_defs.yaml"
    type_def: ClassVar[str] = (
        "'RASTER:\n  id: 1001\n  fields:\n    seq_no: unsigned long\n    bins: unsigned long[32]\n    ai_0: unsigned char[32]\n    ai_1: unsigned char[32]\n    ai_2: unsigned char[32]\n    ai_3: unsigned char[32]\n    ai_4: unsigned char[32]\n    ai_5: unsigned char[32]\n    ai_6: unsigned char[32]\n    ai_7: unsigned char[32]\n    ai_8: unsigned char[32]\n    ai_9: unsigned char[32]\n    ai_10: unsigned char[32]\n    ai_11: unsigned char[32]'"
    )

    seq_no: Uint32 = Uint32()
    bins: IntArray[Uint32] = IntArray(Uint32, 32)
    ai_0: ByteArray = ByteArray(32)
    ai_1: ByteArray = ByteArray(32)
    ai_2: ByteArray = ByteArray(32)
    ai_3: ByteArray = ByteArray(32)
    ai_4: ByteArray = ByteArray(32)
    ai_5: ByteArray = ByteArray(32)
    ai_6: ByteArray = ByteArray(32)
    ai_7: ByteArray = ByteArray(32)
    ai_8: ByteArray = ByteArray(32)
    ai_9: ByteArray = ByteArray(32)
    ai_10: ByteArray = ByteArray(32)
    ai_11: ByteArray = ByteArray(32)


@pyrtma.message_def
class MDF_STATUS(MessageData, metaclass=MessageMeta):
    type_id: ClassVar[int] = 1002
    type_name: ClassVar[str] = "STATUS"
    type_hash: ClassVar[int] = 0x704571A8
