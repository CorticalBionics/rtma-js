...
#define SAMPLE_LENGTH_MS                                    (10 * RAW_COUNTS_PER_SAMPLE) // milliseconds
#define SAMPLE_LENGTH                                       0.02 //(0.01 * RAW_COUNTS_PER_SAMPLE) // seconds (float calculation not compatible with all message def compilers)
...
#define MECH_STIM_SINE										1
#define MECH_STIM_RAMP_AND_HOLD								2
...
#define MID_CEREBUS                                         12  //DO NOT ADD ANYTHING BETWEEN 12 and 15! the cerebus module adds nsp_index to this to maintain unique numbers
#define MID_RAW_LOGGER										16
...
// gamification
#define MT_GET_USER_RESPONSE								1761
#define MT_USER_RESPONSE_L                                  1762
#define MT_USER_RESPONSE_R                                  1763
...
#define MT_MECH_SYNC_EVENT									1817
...
#define MT_SET_START                                        1915
#define MT_SET_END                                          1916
#define MT_BLOCK_START                                      1917
#define MT_BLOCK_END                                        1918 // signal
#define MT_SET_METADATA                                     1919
#define MT_EXEC_PAUSE                                       1950    // message to pause/resume exec
...
// gamification
#define MT_STIM_INTERVAL                                    3001
#define MT_USER_SHOT_L                                      3002
#define MT_USER_SHOT_R                                      3003
#define MT_STIM_THRESH                                      3004
...
// Frets on Fire
#define MT_FOFIX_PROMPT					                            3600
#define MT_FOFIX_INPUT					                            3601
#define MT_FOFIX_MISSED					                            3602
#define MT_FOFIX_STIM					                            3603
...
#define MT_CERESTIM_HEARTBEAT								4014	//Thing charles asked for the both specify cerestim type and confirm has not crashed
#define MT_CERESTIM_HEARTBEAT_RQST							4015
#define MT_CERESTIM_SAFETY_ALIVE							4016
#define MT_CERESTIM_SAFETY_ALIVE_RQST						4017
...
// Lux Sensor
#define MT_VEML7700_SYNC 									4248
#define MT_VEML7700_DATA 									4249
#define MT_VEML7700_PING 									4250
#define MT_VEML7700_PONG 									4251
#define MT_VEML7700_START 									4252
#define MT_VEML7700_STOP 									4253
#define MT_VEML7700_RESET 									4254
#define MT_VEML7700_CONNECT 								4256

//Mechanical Indenter Messages (JW increased all by 20 to avoid conflict w/ lux sensor)
#define MT_MECH_STIM_CONFIGURE                              4260
#define MT_MECH_STIM_RESET                                  4261
#define MT_MECH_STIM_STAGE                                  4262
#define MT_MECH_STIM_WAITING                                4263
#define MT_MECH_STIM_TRIGGER                                4264
#define MT_MECH_STIM_CANCEL                                 4265
#define MT_MECH_STIM_DONE                                   4266
#define MT_MECH_STIM_ERROR                                  4267
#define MT_UC_MECH_STIM_CONFIGURE                           4268
...
typedef struct
{
	...
	int num_blocks;
	int num_trials;
	int stim_trigger; // boolean
	int subject_response; // boolean
	int reserved;
	char session_type[128]; // character fields must be at bottom to avoid issues reading in Python
	char subject_id[64];
	char data_path[128];
} MDF_SET_METADATA; // sent at start of trial
...
typedef struct
{
	...
	unsigned int data;
	int reserved;
} MDF_MECH_SYNC_EVENT; // special type of digital event
...
typedef struct {
	int pause; // 1: pause, 0: resume
	int reserved;
} MDF_EXEC_PAUSE; // message to allow other modules to request that executive pause or resume task

typedef struct {
  unsigned long timestamp;
  unsigned long sync_idx;
} MDF_VEML7700_SYNC;
...
{
	double amp;
	double speed; //Freq or Speed
	double offset;
	double phase;
	double duration;
    int type;
    int padding;
} MDF_UC_MECH_STIM_CONFIGURE;

typedef struct {
    int src; // src MID sending this config
    int dest; // destination MID intended to receive this config
    char json_config[256]; // config data as a JSON string
} MDF_JSON_CONFIG;
